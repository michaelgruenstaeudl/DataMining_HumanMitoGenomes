...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Compute sequence length statistics from a FASTQ file.")
    parser.add_argument("--fastq_file", type=str, required=True, help="Path to the FASTQ file")
