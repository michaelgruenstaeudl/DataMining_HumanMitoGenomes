...
include { plot_size_diff as plot_genome_comparison } from './modules/plot_size_diff.nf'
...
// include { plot_size_diff as plot_genome_comparison } from './modules/plot_genome_comparison.nf'

workflow {
    parent_output_dir = params.outdir
    plot_genome_comparison_input_ch = channel.fromPath(params.rotated_genome_info_csv)
