...
workflow {
    ...
    final_evenness_calculation_input_ch = contamination_removal.out.contamination_removal_fastq_output.join(gb_channel).join(fasta_channel)
    ...
    denovo_assmebly_input_ch = contamination_removal.out.contamination_removal_fastq_output
